    ...
    !error && (
      <DialogPrimitive.Root>
        <DialogPrimitive.Trigger>
          <motion.div className="flex h-fit w-full cursor-pointer select-none flex-col overflow-hidden rounded-xl border-2 border-white bg-white text-black drop-shadow-md hover:border-dark/50 dark:border-dark dark:bg-dark dark:text-white dark:hover:border-light/50">
            <motion.img
              initial={{ opacity: 0 }}
